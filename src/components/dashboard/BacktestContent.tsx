    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 text-sm bg-primary text-white rounded-lg hover:bg-[#6E7AE2] transition-all"
        >
          ...
          >
            <div className="border border-primary/20 rounded-lg bg-primary/5 p-4">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="px-2 py-0.5 text-[10px] bg-primary/20 text-[#9AA5EF] rounded">BETA</span>
              </div>
              <SimulationWidget
