      ...
      <div className="flex-shrink-0 p-3 border-b border-white/[0.06]">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-3 py-2 bg-white/[0.03] border border-white/[0.06] rounded-lg text-xs text-white placeholder-zinc-500 focus:outline-none focus:border-primary/50"
          />
          {isLoading && (
