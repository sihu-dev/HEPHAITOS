      ...
      <main className="flex-1 flex items-center justify-center px-4 pb-12">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-zinc-400 mt-2">{t('auth.login.subtitle')}</p>
          </div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="text-xs text-zinc-400">{t('auth.login.password')}</label>
                  <Link href="/auth/reset-password" className="text-xs text-zinc-500 hover:text-white transition-colors">
